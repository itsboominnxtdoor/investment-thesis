  ...
  return (
    <Card>
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <Metric
          label="EPS (Diluted)"
          value={typeof snapshot.eps_diluted === "number" ? snapshot.eps_diluted.toFixed(2) : typeof snapshot.eps_diluted === "string" ? parseFloat(snapshot.eps_diluted).toFixed(2) : "—"}
          icon={
            <svg className="h-3.5 w-3.5" fill="currentColor" viewBox="0 0 20 20">
        ...
        <Metric
          label="D/E Ratio"
          value={typeof snapshot.debt_to_equity === "number" ? snapshot.debt_to_equity.toFixed(2) : typeof snapshot.debt_to_equity === "string" ? parseFloat(snapshot.debt_to_equity).toFixed(2) : "—"}
          icon={
            <svg className="h-3.5 w-3.5" fill="currentColor" viewBox="0 0 20 20">
